                ...
                <div class="mt-4 mb-3 p-3  button-container bg-white border shadow-sm">
                    ...
                    <form action="index.php?action=addNDS" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <textarea type="text" rows="2" placeholder="liste des destinataires" style="text-transform: uppercase;" class="form-control" id="recipient" name="recipient" required></textarea>
                            </div>
                        </div>
