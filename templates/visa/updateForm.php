...
<body>
    ...
    <div class="col-sm-9 col-xs-12 content pt-3 pl-0">
        <h5 class="mb-3"><strong>Visa updating </strong></h5>
        <div class="row">
            <div class="col-sm-12">
                <div class="mt-4 mb-3 p-3  button-container bg-white border shadow-sm">
                    <h6 class="mb-4">VISA INFOS</h6>
                    <form action="index.php?action=updateVisa&visa_id=<?= $visa->visa_id ?>" method="post">


                        <div class="form-group row">
                            <label class="control-label col-sm-3" for="passnumber">VISA NUMBER</label>
                            <div class="col-sm-5">
                                <input type="text" style="text-transform: uppercase;" class="form-control" value="<?= $visa->visaNumber ?>" id="visanumber" name="visanumber" required />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input type="text" style="text-transform: uppercase;" class="form-control" value="<?= $visa->passNumber ?>" id="passnumber" name="passnumber" required />
                            </div>
                        </div>
