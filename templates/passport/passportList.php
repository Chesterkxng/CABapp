...
<body>
    ...
    <div class="col-sm-9 col-xs-12 content pt-3 pl-0">
        <h5 class="mb-3"><strong> AVAILABLE PASSPORTS LIST</strong></h5>
        <div class="row mt-3">
            <div class="col-sm-12">
                <!--Striped table-->
                <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">
                    <div class="table-responsive">
                        <table class="table table-striped" id="AvailablePassports-table">
                            <thead>
                                <tr>
                                    <th>N°</th>
                                    <th>PASSNUMBER </th>
        ...
        <h5 class="mb-3"><strong>EXPIRED PASSPORTS LIST</strong></h5>
        <div class="row mt-3">
            <div class="col-sm-12">
                <!--Striped table-->
                <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">
                    <div class="table-responsive">
                        <table class="table table-striped" id="ExpiredPassports-table">
                            <thead>
                                <tr>
                                    <th>N°</th>
                                    <th>PASSNUMBER </th>
