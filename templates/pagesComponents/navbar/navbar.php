    ...
    <div class="row header shadow-sm">
        ...
        <div class="col-sm-3 pl-0 text-center header-logo">
            <div class="bg-theme mr-3 pt-3 pb-2 mb-0">
                <h3 class="logo"><a href="#" class="text-secondary logo"><i class="fa fa-university"></i> CAB<span class="small">APP</span></a></h3>
            </div>
        </div>
        <!--Logo-->
        <!--Header Menu-->
                            ...
                            <ul class="sidebar-menu mt-4 mb-4">
                                ...
                                <li class="parent">
                                    ...
                                    <ul class="children" id="mission_orders">
                                        ...
                                        <li class="child"><a href="index.php?action=extMOgenerator" class="ml-4"><i class="fa fa-angle-right mr-2"></i> EXTERIEUR</a></li>
                                        <li class="child"><a href="index.php?action=DOMgenerator" class="ml-4"><i class="fa fa-angle-right mr-2"></i> DEMANDE</a></li>
                                ...
                                <li class="parent">
                                    <a href="#" onclick="toggle_menu('archives'); return false" class=""><i class="fa fa-archive mr-3"> </i>
                                        <span class="none">ARCHIVES<i class="fa fa-angle-down pull-right align-bottom"></i></span>
                                    </a>
                                    <ul class="children" id="archives">
                                        <li class="child"><a href="index.php?action=archiveAddingForm" class="ml-4"><i class="fa fa-angle-right mr-2"></i> ADD DOCUMENT</a></li>
                                        <li class="child"><a href="index.php?action=Archives" class="ml-4"><i class="fa fa-angle-right mr-2"></i> ARCHIVES</a></li>
                                    </ul>
                                </li>

                                <li class="parent">
                                    <a href="#" onclick="toggle_menu('accessControls'); return false" class=""><i class="fa fa-key mr-3"> </i>
                                        <span class="none">CONTROLE D'ACCES<i class="fa fa-angle-down pull-right align-bottom"></i></span>
                                    </a>
