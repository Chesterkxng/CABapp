	...
	<div class="col-md-6 col-lg-4">
		<div class="login-wrap p-0">
			...
			<form action="index.php?action=signUp" method='post' class="signin-form">
				...
				<div class="form-group">
					<select id="password-field" id="security_question" name="security_question" class="form-control"
						required>
						<option class="option" value=""> Choose your question </option>
						<option class="option" value="Quel est le nom de votre meilleur ami ?">Quel est le nom de votre
							meilleur ami ?</option>
						<option class="option" value="Quel est le nom de votre animal de compagnie ?">Quel est le nom de
							votre animal de compagnie ?</option>
						<option class="option" value="Quel est le métier de votre grand-père ?">Quel est le métier de
							votre grand-père ?</option>
					</select>
				</div>
				<div class="form-group">
