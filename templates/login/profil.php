	...
	<div class="col-md-6 col-lg-4">
		<div class="login-wrap p-0">
			...
			<form action="index.php?action=profileCompletion" method='post' class="signin-form">
				...
				<div class="form-group">
					<input id="password-field" autocomplete="off" type="text" id="surname" name="surname"
						class="form-control" placeholder="Surname" required>
				</div>
				<div class="form-group">
					<input type="text" class="form-control" autocomplete="off" id="firstName" name="firstName"
						placeholder="First Name" required>
				</div>
				<div class="form-group">
					<input id="password-field" autocomplete="off" type="text" id="function" name="function"
						class="form-control" placeholder="Function" required>
				</div>
				<div class="form-group">
					<button type="submit" class="form-control btn btn-primary submit px-3">Complete your
						profile</button>
				</div>
			</form>
