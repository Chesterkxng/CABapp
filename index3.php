...
use Application\Model\NDS\NDS as NDSNDS;
...
try {
    if (isset($_GET['action']) && $_GET['action'] !== '') {
        ...
        } elseif ($_GET['action'] === 'ndsAddingForm') {
            $found = 1;
            if (isset($_SESSION['ISAUTH'])) {
                $isAuth = $_SESSION['ISAUTH'];
                $profile_type = $_SESSION['profile_type'];
        ...
        } elseif ($_GET['action'] === 'NDSupdatingForm') {
            $found = 1;
            $nds_id = $_GET['nds_id'];
            if (isset($_SESSION['ISAUTH'])) {
                $isAuth = $_SESSION['ISAUTH'];
        ...
        } elseif ($_GET['action'] === 'deleteNDSPopup') {
            $found = 1;
            $nds_id = $_GET['nds_id'];
            if (isset($_SESSION['ISAUTH'])) {
                $isAuth = $_SESSION['ISAUTH'];
        ...
        } elseif ($_GET['action'] === 'MSGAddingForm') {
            $found = 1;
            if (isset($_SESSION['ISAUTH'])) {
                $isAuth = $_SESSION['ISAUTH'];
                $profile_type = $_SESSION['profile_type'];
        ...
        } elseif ($_GET['action'] === 'MSGupdatingForm') {
            $found = 1;
            $msg_id = $_GET['msg_id'];
            if (isset($_SESSION['ISAUTH'])) {
                $isAuth = $_SESSION['ISAUTH'];
        ...
        } elseif ($_GET['action'] === 'deleteMSGPopup') {
            $found = 1;
            $msg_id = $_GET['msg_id'];
            if (isset($_SESSION['ISAUTH'])) {
                $isAuth = $_SESSION['ISAUTH'];
        ...
        } elseif ($_GET['action'] === 'beAddingForm') {
            $found = 1;
            if (isset($_SESSION['ISAUTH'])) {
                $isAuth = $_SESSION['ISAUTH'];
                $profile_type = $_SESSION['profile_type'];
        ...
        } elseif ($_GET['action'] === 'BEupdatingForm') {
            $found = 1;
            $be_id = $_GET['be_id'];
            if (isset($_SESSION['ISAUTH'])) {
                $isAuth = $_SESSION['ISAUTH'];
        ...
        } elseif ($_GET['action'] === 'deleteBEPopup') {
            $found = 1;
            $be_id = $_GET['be_id'];
            if (isset($_SESSION['ISAUTH'])) {
                $isAuth = $_SESSION['ISAUTH'];
