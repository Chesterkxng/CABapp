...
class PassportRepository 
{
    ...
    public function addPassport(string $passNumber, string $grade, string $surname, 
        string $firstname, string $deliveryDate, string $expirationDate) : bool {
    ...
    public function updatePassport ($passNumber, string $grade, string $surname, 
