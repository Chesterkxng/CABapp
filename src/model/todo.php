...
class TodoRepository 
{
    ...
    public function AddTodo(int $personal_id, string $title, string $details, 
        string $deadline, int $recipient): bool {
        ...
        public function updateTodo( string $title, string $details, 
        string $deadline, int $recipient, int $personal_id, int $todo_id): bool {
