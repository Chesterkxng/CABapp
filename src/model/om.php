...
class OMRepository
{
    ...
    public function addOM(string $recipient, string $country, string $city, string $companions, string $object, string $means,
    string $departure_date, string $return_date, string $type ): bool{
